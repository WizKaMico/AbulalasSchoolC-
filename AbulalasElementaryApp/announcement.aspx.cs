...
namespace AbulalasElementaryApp
{
    public partial class announcement : System.Web.UI.Page
    {
        ...
        private void announcementList()
        {
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string checkAnnouncementTotal = "SELECT * FROM announcement";
                    ...
                    announcementGridView.DataSource = dt;
                    announcementGridView.DataBind();
                }
            }
            catch (Exception ex)
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand(checkAnnouncementTotal, connection))
                {
                    ...
                    using (MySqlDataAdapter da = new MySqlDataAdapter(cmd))
                    {
                        ...
                        using (XLWorkbook wb = new XLWorkbook())
                        {
                            ...
                            var ws = wb.Worksheets.Add("AnnouncementList");
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=AnnouncementList.xlsx");
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings["MySqlConnection"].ConnectionString;
            string checkAnnouncementTotal = "SELECT * FROM announcement WHERE title LIKE @searchQuery OR body LIKE @searchQuery";
