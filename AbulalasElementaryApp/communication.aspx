<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="AbulalasElementaryApp.communication" %>
        ...
        <div class="row" style="margin-top:20px; display: flex; justify-content: center; align-items: center;">
            <div class="col-md-3">
                <div class="content-with-shadow" style="background-color:#eece32;">
                     ...
                     <br />
                     <asp:HyperLink ID="HyperLink1" runat="server"  class="rounded-button" NavigateUrl="~/home.aspx">PROCEED</asp:HyperLink>
                </div>
            </div>
        </div>
