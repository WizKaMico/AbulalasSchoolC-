<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enrollment.aspx.cs" Inherits="AbulalasElementaryApp.enrollment" %>
                   ...
                   <div class="col-md-12">
                     <div class="content-with-shadow">
                        ...
                        <asp:Button ID="btnExportToExcel" runat="server" Text="DOWNLOAD TO EXCEL" OnClick="btnExportToExcel_Click" CssClass="createRequestBtn"/>
                         <asp:GridView ID="enrollmentGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                            ...
                            <Columns>
                                <asp:BoundField DataField="eid" HeaderText="LRN" ItemStyle-Width="150px"/>
                                ...
                                <asp:BoundField DataField="gen_ave" HeaderText="AVE" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="level" HeaderText="LEVEL" ItemStyle-Width="150px"/>
