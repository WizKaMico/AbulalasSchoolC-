<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lost.aspx.cs" Inherits="AbulalasElementaryApp.lost" %>
                   ...
                   <div class="col-md-12">
                     <div class="content-with-shadow">
                        ...
                        <asp:Button ID="btnExportToExcel" runat="server" Text="DOWNLOAD TO EXCEL" OnClick="btnExportToExcel_Click" CssClass="createRequestBtn"/>
                         ...
                         <asp:GridView ID="lostGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                            ...
                            <Columns>
                                <asp:BoundField DataField="fid" HeaderText="ID" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="item" HeaderText="ITEM" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="foundby" HeaderText="FOUNDER" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="foundin" HeaderText="FOUND" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="status" HeaderText="STATUS" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="another" HeaderText="COMMENT" ItemStyle-Width="150px"/>
