<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="request.aspx.cs" Inherits="AbulalasElementaryApp.request" %>
            ...
            <div class="row" style="margin-top:20px;">
                   <div class="col-md-12">
                     <div class="content-with-shadow">
                         ...
                         <asp:GridView ID="requestGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                            ...
                            <Columns>
                                <asp:BoundField DataField="uid" HeaderText="UID" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="request_type" HeaderText="EMAIL" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="date_requested" HeaderText="REGISTERED" ItemStyle-Width="150px"/>
                                <asp:BoundField DataField="status" HeaderText="GRADE" ItemStyle-Width="150px"/>
